    ...
    return Stack(
      children: [
        ...
        Positioned(
          ...
          child: Row(
            children: [
              statsNoteTimeline(value: viewNote8),
              SizedBox(
                width: 57.w,
              ),
              statsNoteTimeline(value: viewNote7),
              SizedBox(
                width: 55.w,
              ),
              statsNoteTimeline(value: viewNote6),
              SizedBox(
                width: 57.w,
              ),
              statsNoteTimeline(value: viewNote5),
              SizedBox(
                width: 57.w,
              ),
              statsNoteTimeline(value: viewNote4),
            ],
          ),
        ),
      ],
